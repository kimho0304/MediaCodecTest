...
public class ExtractDecodeEditEncodeMuxTest extends AndroidTestCase{
    public static AssetFileDescriptor srcFd;
    ...
    public void testExtractDecodeEditEncodeMuxAudioVideo(OutputSurface s) throws Throwable {
        mOutputSurface = s;
        setSize(1280, 720);
        setSource(R.raw.heartless);
        setCopyAudio();
        setCopyVideo();
        TestWrapper.runTest(this);
    }
    ...
    private static class TestWrapper implements Runnable {
        ...
        public static void runTest(ExtractDecodeEditEncodeMuxTest test) throws Throwable {
            test.setOutputFile();
            Log.i(TAG, "setOutputFile worked");
    ...
    private void setOutputFile() throws IOException {
        outFile = File.createTempFile("tmp", "mp4");
    ...
    public static OutputSurface mOutputSurface = null;
    public static SurfaceTexture st = null;
        ...
        MediaCodec.Callback callback = new MediaCodec.Callback() {
            ...
            public void onInputBufferAvailable(MediaCodec codec, int index) {
                ...
                while (!mVideoExtractorDone) {
                    ...
                    mVideoExtractorDone = !mVideoExtractor.advance() && size == -1;
    ...
    private void awaitEncode() {
        ...
        // Basic sanity checks.
        if (mCopyVideo) {
            //assertEquals("encoded and decoded video frame counts should match",mVideoDecodedFrameCount, mVideoEncodedFrameCount);
            //assertTrue("decoded frame count should be less than extracted frame count",mVideoDecodedFrameCount <= mVideoExtractedFrameCount);
        }
        if (mCopyAudio) {
