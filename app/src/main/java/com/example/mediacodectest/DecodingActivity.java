...
public class DecodingActivity {
     ...
     * @throws IOException
     */
    public DecodingActivity(File sourceFile, Surface outputSurface, FrameCallback frameCallback)
            throws IOException {
    ...
    public static class PlayTask implements Runnable {
        ...
        private DecodingActivity mPlayer;
         ...
         */
        public PlayTask(DecodingActivity player, PlayerFeedback feedback) {
            mPlayer = player;
            mFeedback = feedback;
